...
| 주차 | 주요 마일스톤 | 산출물 | v0.4 진척 (S346) |
|---|---|---|---|
| **W18 (5/4~10)** | 정의서 v0.1 합의 회의 + Pre-착수 PoC + ax-plugin 메타 정리 | 의사록 + 코어 5명 지정 | ✅ **완료 + W19 사전 진척**: P0 4건 토대 ✅ (F602/F603/F606/F607 MERGED), 41 sprint 연속 성공 (S306~S346, F560~F641), C-1 ✅ 자체 통과 증거 (Sinclair PM 개입 < 10%) |
| **W19 (5/11~17, 5/15 BeSir D-day)** | BeSir Conditional C-1·C-2·C-3·C-4 게이트 통과 + 5-Layer 모듈 스펙 v0.1 작성 시작 | C-1 ✅ 통과 증거 + C-2/C-4 BeSir sign-off + spec drafts | 🔧 **진행 (D-5)**: C-1 ✅ 자체 / C-2/C-4 외부 의존 (5/15 BeSir 미팅 sign-off 대기) / C-3 W20 진행. 18 v1 + 20 demo + executive v3 사전 자료 ✅ 완비 |
| **W20 (5/18~24)** | 모듈 스펙 v0.5 + 인터페이스 카탈로그 v0.1 + LLM·Graph DB 공급자 선정 + KPI 6/8 베이스라인 측정 | 스펙·카탈로그 1차 + 공급자 결정 + KPI 측정 결과 | 📋 KPI 6개 측정 코드 ✅ 사전 준비 (F602/F603/F607/F626/F629), 본부 데이터 협조 unlock 후 즉시 |
| **W21 (5/25~31)** | **G1+G2 통합 게이트** — 정의서 v1.0 + 모듈 스펙 v1.0 + 임원 결재 | **Phase 1 종료, Phase 2 즉시 착수** | 📋 02 v0.4 patch ✅ → v1.0 sign-off 가능 상태 (BeSir 미팅 결과 흡수 후) |
